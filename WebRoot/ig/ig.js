...
Object.addEvent(window, ["onload"], function () {
    var wc = new CDrag;
    if($B("ig_1_3")==null)wc.parse([{cols:$B("c_1"), rows:[$B("ig_1_1"), $B("ig_1_2")]}, {cols:$B("c_2"), rows:[$B("ig_2_1")]}]);;    
    if($B("ig_1_3")!=null)wc.parse([{cols:$B("c_1"), rows:[$B("ig_1_1"), $B("ig_1_2"),$B("ig_1_3"), $B("ig_1_4")]}, {cols:$B("c_2"), rows:[$B("ig_2_1")]}]);
});
...
function sendRequest(url, queryStr, divId,src) {
        ...
        if (xmlHttp.readyState == 4) { 
            if (xmlHttp.status == 200) { 
                var text = xmlHttp.responseText;
                  if(document.getElementById(divId) !=null && document.getElementById(divId)!=""){
                       processText(text,document.getElementById(divId),src);
                  }
            }
        }
    }
